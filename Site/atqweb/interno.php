...
require_once 'Classes/Noticias.php';//by GM

$db = new Mysql();
$funcoes = new Funcoes();
$usuarios = new Usuarios();
$info = new Info();//dados email contato
$conteudo = new	Conteudo();
$Noticia = new Noticias();//by GM
...
<head>
  ...
  <meta name="author" content="Rafael Franco | Gilberto Moraes | Ataque Propaganda">
        ...
        <ul class="nav navbar-nav">
          ...
          <?php  if ($usuario->getTipo() == "ADMIN") { ?>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="CadastrarNoticia">Cadastrar Noticia</a></li>
            ...
            <?php  if ($usuario->getTipo() == "ADMIN") { ?>
              <li>
                <a href="AtualizarInfoContato"> Email Contato</a>
              </li>
