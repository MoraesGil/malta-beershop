...
<?php 
	...
	if(isset($_POST['atualizar'])){
					$db->conecta();
					$igreja->atualizarConteudoIgreja();	
					$db->fechaConexao();
...
?>
        ...
        <p>Você está em -> <a href="Home">Home </a>-> Atualizar Conteúdo Igreja</p>
  ...
  <form class="form" role="form" action="" method="post" enctype="multipart/form-data">
        ...
        BG Título:<br>
        <img src="igreja/<?php echo $ln->not_bg_titulo; ?>" style="height:60px; " />
                                    ...
                                    $(document).ready(function() {                
                                        $('#fupload').uploadify({
                                            ...
                                            'onAllComplete': function(event, queueID, fileObj,response){
                                                ...
                                                window.location = 'AtualizarConteudoIgreja&id=<?php echo $id; ?>';
