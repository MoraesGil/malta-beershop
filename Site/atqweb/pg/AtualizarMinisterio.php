...
?>
        ...
        <p>Você está em -> <a href="Home">Home </a>-> Atualizar Ministério</p>
  ...
  <form class="form" role="form" action="" method="post" enctype="multipart/form-data">
        ...
        Título Topo:
        <input type="text" class="form-control" required autofocus name="not_titulo_topo" value='<?php echo $ln->not_titulo_topo; ?>'>
        BG Título:<br>
        <img src="ministerio/<?php echo $ln->not_bg_titulo; ?>" style="height:60px; " />
        ...
        <input type="hidden" name="not_tipo" value="M">
        Visualizar:
                                    ...
                                    $(document).ready(function() {                
                                        $('#fupload').uploadify({
                                            ...
                                            'onAllComplete': function(event, queueID, fileObj,response){
                                                ...
                                                window.location = 'AtualizarMinisterio&id=<?php echo $id; ?>';
