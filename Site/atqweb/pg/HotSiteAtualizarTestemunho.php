<?php 
	if(isset($_POST['atualizar'])){
					$db->conecta();
					$hotsitetestemunho->atualizar();	
					$db->fechaConexao();
					
}
@$id = $_REQUEST['id'];
$db->conecta();
$db->query("SELECT * FROM hotsite_testemunho WHERE hotsite_pedid='$id' LIMIT 1;")->fetchAll();
    if ( $db->rows >= 1 ) 
		{ // linhas
...
?>
      ...
      <p>Você está em -> <a href="Home">Home </a>-> <a href="HotSiteTestemunhoCadastrados">HOT SITE - Testemunho Cadastrados </a>-> <a href="HotSiteAtualizarTestemunho&id=<?php echo $ln->hotsite_pedid; ?>">Atualizar Testemunho</a></p>
    ...
    <form class="form" role="form" action="" method="post" enctype="multipart/form-data">
        ...
        Membro:
       	 <select id="hotsite_pedmembro" name="hotsite_pedmembro" class="form-control" required="required">
        ...
        Foto:
       	...
       	echo '<img src="images/hotsite/testemunho/'.$ln->hotsite_pedimg.'" class="img-responsive" style="width:220px;" border="0" />'; 
       		}
       		?>
