<article class=" rowTop" id="nat-power_pg">
  <div class="container containerTopo">
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6" >
        <div class="divLeft">
          <h1> NATPOWER <br> ENERGY DRINK</h1>
          <p class="infoItem animate-in slow-mo" data-anim-type="fade-in-left" data-anim-delay="0">
            ...
            Teor Calórico: 78 kcal/200 ml
          </p>

          <p class="infoItem animate-in slow-mo" data-anim-type="fade-in-left" data-anim-delay="0">
            <span class="infoTitle">  Ingredientest:</span><br>
            Agua natural gaseificada, açúcar, taurina, <br> cafeína e glucoronolactona.
          </p>


          <p class="infoItem animate-in slow-mo" data-anim-type="fade-in-left" data-anim-delay="0">
            <span class="infoTitle">  Embalagens:</span><br>
            Garrafa retornável 2 L <br>
            Garrafa retornável 1 L <br>
            Garrafa retornável 600ml <br>
            Lata 269ml
          </p>
  ...
  <div>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 hidden-xs">
          <img class="detail-img2 animate-in" data-anim-type="fade-in" data-anim-delay="470" src="<?php echo $baseUrl?>_/images/marcas_detail/natpower-energy-drink/2.png" alt="" />
        </div>
