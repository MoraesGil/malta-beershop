<article class=" rowTop" id="cristalina-guarana-zero_pg">
  <div class="container containerTopo">
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6" >
        <div class="divLeft">
          <h1> CRISTALINA <br> GUARANÁ ZERO</h1>
      ...
      <div class="col-md-6 col-sm-6 hidden-xs " >
        <img class="detail-img1 "  src="<?php echo $baseUrl?>_/images/marcas_detail/cristalina-guarana-zero/1.png" alt=""  />
      </div>
    </div>
  </div>
</article>
  ...
  <div>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 hidden-xs">
          <img class="detail-img2 animate-in" data-anim-type="fade-in" data-anim-delay="470" src="<?php echo $baseUrl?>_/images/marcas_detail/cristalina-guarana-zero/2.png" alt="" />
        </div>
