      ...
      <div class="col-md-6 col-sm-6">
        <div class="divLeft">
          ...
          <p class="infoItem">
            ...
            Definição/Tipo: Chopp Claro Tipo Pilsen<br>
  ...
  <div>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 hidden-xs">
          <img  class="detail-img2 chopp2 animate-in" data-anim-type="fade-in" data-anim-delay="470" src="<?php echo $baseUrl?>_/images/marcas_detail/chopp/2.png" alt="" />
        </div>
