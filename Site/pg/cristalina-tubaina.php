<article class=" rowTop" id="cristalina-tubaina_pg">
  <div class="container containerTopo">
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6" >
        <div class="divLeft">
          ...
          <p class="infoItem animate-in slow-mo" data-anim-type="fade-in-left" data-anim-delay="0">
            ...
            Teor Calórico - 78kcal / 200ml
          </p>

          <p class="infoItem animate-in slow-mo" data-anim-type="fade-in-left" data-anim-delay="0">
            <span class="infoTitle">  Ingredientest:</span><br>
            Água gaseificada, açúcar, taurina, <br>
            cafeína e glucoronolactona.
      ...
      <div class="col-md-6 col-sm-6 hidden-xs " >
        <img id="cristalina-tubaina1" class="detail-img1 "  src="<?php echo $baseUrl ?>_/images/marcas_detail/cristalina-tubaina/1.png" alt=""  />
      </div>
    </div>
  </div>
</article>
  ...
  <div>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 hidden-xs">
          <img class="detail-img2 animate-in" data-anim-type="fade-in" data-anim-delay="470" src="<?php echo $baseUrl?>_/images/marcas_detail/cristalina-tubaina/2.png" alt="" />
        </div>
