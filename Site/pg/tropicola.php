...
.bg{
  ...
  padding-left:3%;
  padding-right: 3%;
  background:url(_/images/marcas-detalhado/tropicola/bg.jpg) #688082 no-repeat;
  width:100%;
      ...
      <div class="col-md-12">
        ...
        <div class="row ">
          <div class="col-md-6">
            ...
            <div class="row">
              <img class="img-responsive pull-right seta hidden-xs hidden-sm" src="_/images/marcas-detalhado/tropicola/seta.png" alt="" />
            </div>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12">
                <div id="info">
                  ...
                  <p>
                    Ingredientes: <br>
                    <em>Água gaseificada, Açúcar, Extrato de noz de cola</em>
                  </p>
                  <p>
                    Embalagens: <br>
                    <em>
          ...
          <div class="col-md-6 hidden-xs hidden-sm ">
            <img class="img-responsive center-block seta" src="_/images/marcas-detalhado/tropicola/principal.png" alt="" />
