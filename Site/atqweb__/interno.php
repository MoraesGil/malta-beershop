...
require_once 'Classes/Parceiros.php';
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<?php	 
			 ...
			 <li><a href="AtualizarEmpresa" >Empresa </a>  </li>
             <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Serviços<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="AtualizarServicos&id=1">Hospedagem</a></li>
                <li><a href="AtualizarServicos&id=2">Recreação</a></li>
                <li><a href="AtualizarServicos&id=3">Spa & Reabilitação</a></li>
                <li><a href="AtualizarServicos&id=4">Taxi Dog</a></li>
                <li><a href="AtualizarServicos&id=5">Banho e Tosa</a></li>
                <li><a href="AtualizarServicos&id=6">Asilo</a></li>
                <li><a href="AtualizarServicos&id=7">Consulta Comportamental</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Vitrine <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="CadastrarVitrine">Cadastrar Vitrine</a></li>   
                <li><a href="VitrineCadastradas">Vitrine Cadastradas</a></li>
              </ul>
            </li>
              
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Dúvidas<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="CadastrarDuvidas">Cadastrar Dúvidas</a></li>
                <li><a href="DuvidasCadastradas">Dúvidas Cadastradas</a></li>

              </ul>
            </li>  
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Depoimentos<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="CadastrarDepoimentos">Cadastrar Depoimentos</a></li>
                <li><a href="DepoimentosCadastrados">Depoimentos Cadastrados</a></li>

              </ul>
            </li>  
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Aniversariantes<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="CadastrarAniversariantes">Cadastrar Aniversariantes</a></li>
                <li><a href="AniversariantesCadastrados">Aniversariantes Cadastrados</a></li>
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="CadastrarParceiros">Cadastrar Parceiros</a></li>
                <li><a href="ParceirosCadastrados">Parceiros Cadastrados</a></li>
