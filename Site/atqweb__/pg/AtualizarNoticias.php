...
?>
        ...
        <p>Você está em -> <a href="Home">Home </a>-> Atualizar Notícias</p>
  ...
  <form class="form" role="form" action="" method="post" enctype="multipart/form-data">
		...
		Título:
        <input type="text" class="form-control"  autofocus name="not_titulo" value='<?php echo $ln->not_titulo; ?>'>
        Descrição:
        <input type="text" class="form-control"  autofocus name="not_descricao" value='<?php echo $ln->not_descricao; ?>'>
        Frase destaque:
        <input type="text" class="form-control"  autofocus name="not_frase" value='<?php echo $ln->not_frase; ?>'>
          Data de Postagem:
        <input type="date" class="form-control" name="not_date" aria-required="true" id="subject" class="form-control"  value="<?php echo $ln->not_date; ?>" />
        Visualizar:
                ...
                <div class="block-border">
                    <div class="block-content">
                        <h1><?php echo $ln->not_titulo; ?> - Postar Fotos
                            ...
                            {
                                ?>
                                <a href="NoticiasCadastradas" class="with-tip"  title="Todas as Notícias">
                        ...
                        <div id="home" style="min-height: 600px; overflow-y:auto; ">
                            <p>&nbsp;</p>
                                    ...
                                    $(document).ready(function() {                
                                        $('#fupload').uploadify({
                                            ...
                                            'onAllComplete': function(event, queueID, fileObj,response){
                                                ...
                                                window.location = 'AtualizarNoticias&id=<?php echo $id; ?>';
                               ...
                               <div class="box-album">                                        
									...
									echo	"<p>No momento sua notícia não contém nenhuma foto! <br>Clique em upload para enviar suas fotos... </br></p>";
									}
                                    } 
