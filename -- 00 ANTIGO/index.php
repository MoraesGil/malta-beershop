...
else if ($pagina == "ver-noticia") { echo 'class="blog_classic"'; }
else if ($pagina == "golden") { echo 'style="background:url(http://ataquepropaganda.com.br/malta/_/images/golden-bc.jpg); width:100%"'; }
else if ($pagina == "marcas") { echo 'class="home"'; }
		...
		<div class="row">
			<div class="col col-sm-12">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="home"><img src="_/images/logo-malta.png" class="img-responsive" alt="Logo"></a>
				</div>
