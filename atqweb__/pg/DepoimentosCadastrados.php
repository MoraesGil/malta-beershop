...
<?php
        if ($usuario->getTipo() == "ADMIN") {   
				...
				echo ' <li><a href="DepoimentosCadastrados&pag=1" target="_self" title="Primeira">&laquo;</a></li>';
				for($i = $pag-$max_links; $i <= $pag-1; $i++) {
				 if($i <=0) { 
				} else { 
				echo ' <li ><a href="DepoimentosCadastrados&pag='.$i.'" target="_self">'.$i.'</a></li>';
				} } 
				 echo '<li ><a href="DepoimentosCadastrados&pag='.$i.'" target="_self">'.$pag.'</a></li>'; 
				 for($i = $pag+1; $i <= $pag+$max_links; $i++) { 
				 if($i > $pags) { 
				 } 
				 else { echo '<li><a href="DepoimentosCadastrados&pag='.$i.'" target="_self">'.$i.'</a></li>'; } }
				echo '<li><a href="DepoimentosCadastrados&pag='.$pags.'" target="_self" title="Última">&raquo;</a></li>	';
