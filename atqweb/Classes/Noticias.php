...
class Noticias {	
	...
	public $not_date;
		...
		public function cadastrarNoticias(){
			...
			$this->not_frase = mysql_escape_string($_POST['not_frase']);
			...
			`not_date`, `not_time`, `not_dia`, `not_mes`, `not_ano`, `not_view`, `not_frase`) 
			VALUES 
			('$this->not_titulo', '$this->not_descricao', '$this->not_conteudo', '$this->usuario_id',
			'$data', NOW(), '$this->not_dia', '$this->not_mes', '$this->not_ano', '$this->not_view', '$this->not_frase'
			)");
				if($sql){
